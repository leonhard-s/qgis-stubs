...
class QgsColorButton(QtWidgets.QToolButton):
    ...
    def showMenu(self) -> bool: ...  # type: ignore[override]
...
class QgsDoubleValidator(QtGui.QRegularExpressionValidator):
    ...
    def validate(self, input: str) -> QtGui.QValidator.State: ...  # type: ignore[override]
...
class QgsErrorDialog(QtWidgets.QDialog):
    ...
    @staticmethod
    def show(error: _core.QgsError, title: str, parent: typing.Optional[QtWidgets.QWidget] = ..., fl: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...) -> None: ...  # type: ignore[override]
...
class QgsFieldMappingModel(QtCore.QAbstractTableModel):
    ...
    def setData(self, index: QtCore.QModelIndex, value: typing.Any, role: int) -> bool: ...  # type: ignore[override]
    def flags(self, index: QtCore.QModelIndex) -> QtCore.Qt.ItemFlags: ...
...
class QgsFieldValidator(QtGui.QValidator):
    ...
    def fixup(self, s: typing.Any) -> None: ...  # type: ignore[override]
...
class QgsGeometryRubberBand(QgsMapCanvasItem):
    ...
    def paint(self, painter: QtGui.QPainter) -> None: ...  # type: ignore[override]
    def updatePosition(self) -> None: ...
...
class QgsHighlight(QgsMapCanvasItem):
    ...
    def paint(self, p: QtGui.QPainter) -> None: ...  # type: ignore[override]
    def updatePosition(self) -> None: ...
...
class QgsIdentifyMenu(QtWidgets.QMenu):
    ...
    def exec(self, idResults: typing.Iterable['QgsMapToolIdentify.IdentifyResult'], pos: QtCore.QPoint) -> typing.List['QgsMapToolIdentify.IdentifyResult']: ...  # type: ignore[override]
...
class QgsLongLongValidator(QtGui.QValidator):
    ...
    def validate(self, input: str) -> typing.Tuple[QtGui.QValidator.State, int]: ...  # type: ignore[override]
...
class QgsMapToolAdvancedDigitizing(QgsMapToolEdit):
    ...
    def layer(self) -> _core.QgsMapLayer: ...  # type: ignore[override]
    def cadDockWidget(self) -> QgsAdvancedDigitizingDockWidget: ...
    def deactivate(self) -> None: ...
    def activate(self) -> None: ...
    def canvasMoveEvent(self, e: QgsMapMouseEvent) -> None: ...
...
class QgsMapToolIdentify(QgsMapTool):
    ...
    class IdentifyResult(sip.wrapper):
        ...
        mAttributes: typing.Dict[str, str] = ...
        mDerivedAttributes: typing.Dict[str, str] = ...
        mFeature: _core.QgsFeature = ...
        mFields: _core.QgsFields = ...
        mLabel: str = ...
        mLayer: _core.QgsMapLayer = ...
        mParams: typing.Dict[str, typing.Any] = ...
...
class QgsMessageViewer(QtWidgets.QDialog, _core.QgsMessageOutput):
    ...
    def setTitle(self, title: str) -> None: ...
    def showMessage(self, blocking: bool = ...) -> None: ...  # type: ignore[override]
...
class QgsPointCloudAttributeComboBox(QtWidgets.QComboBox):
    ...
    def setAttribute(self, name: str) -> None: ...  # type: ignore[override]
    def setLayer(self, layer: _core.QgsMapLayer) -> None: ...
    attributeChanged: typing.ClassVar[QtCore.pyqtSignal]
...
class QgsRelationEditorWidget(QgsAbstractRelationEditorWidget):
    ...
    def duplicateFeature(self) -> None: ...  # type: ignore[override]
...
class QgsStyleItemsListWidget(QtWidgets.QWidget):
    ...
    def setStyle(self, style: _core.QgsStyle) -> None: ...  # type: ignore[override]
...
class QgsTabWidget(QtWidgets.QTabWidget):
    ...
    def setTabVisible(self, tab: QtWidgets.QWidget, visible: bool) -> None: ...  # type: ignore[override]
...
class QgsValidityCheckResultsModel(QtCore.QAbstractItemModel):
    ...
    def index(self, row: int, column: int, parent: QtCore.QModelIndex) -> QtCore.QModelIndex: ...  # type: ignore[override]
...
class QgsAttributeTableFilterModel(QtCore.QSortFilterProxyModel, QgsFeatureModel):
    ...
    def setSourceModel(self, sourceModel: 'QgsAttributeTableModel') -> None: ...  # type: ignore[override]
...
class QgsAttributeTableView(QgsTableView):
    ...
    finished: typing.ClassVar[QtCore.pyqtSignal]
    columnResized: typing.ClassVar[QtCore.pyqtSignal]  # type: ignore[assignment]
    ...
    def setModel(self, filterModel: QgsAttributeTableFilterModel) -> None: ...  # type: ignore[override]
...
class QgsFeatureListModel(QtCore.QSortFilterProxyModel, QgsFeatureModel):
    ...
    def data(self, index: QtCore.QModelIndex, role: int) -> typing.Any: ...  # type: ignore[override]
    def layerCache(self) -> _core.QgsVectorLayerCache: ...
    def setSourceModel(self, sourceModel: QgsAttributeTableFilterModel) -> None: ...  # type: ignore[override]
...
class QgsFeatureListView(QtWidgets.QListView):
    ...
    def setModel(self, featureListModel: QgsFeatureListModel) -> None: ...  # type: ignore[override]
    def layerCache(self) -> _core.QgsVectorLayerCache: ...
...
class QgsDrawSourceWidget(QgsPaintEffectWidget):
    ...
    def setPaintEffect(self, effect: _core.QgsPaintEffect) -> None: ...
    @staticmethod
    def create() -> QgsPaintEffectWidget: ...  # type: ignore[override]
...
class QgsElevationProfileCanvas(QgsPlotCanvas):
    ...
    def render(self, context: _core.QgsRenderContext, width: float, height: float, plotSettings: _core.Qgs2DPlot) -> None: ...  # type: ignore[override]
...
class QgsHistoryEntry(sip.wrapper):
    ...
    providerId: str = ...
    timestamp: typing.Union[QtCore.QDateTime, datetime.datetime] = ...
...
class QgsHistoryProviderRegistry(QtCore.QObject):
    ...
    class HistoryEntryOptions(sip.wrapper):
        ...
        storageBackends: typing.Union[_core.Qgis.HistoryProviderBackends, _core.Qgis.HistoryProviderBackend] = ...
...
class QgsLayoutComboBox(QtWidgets.QComboBox):
    ...
    def layout(self, index: int) -> _core.QgsMasterLayoutInterface: ...  # type: ignore[override]
...
class QgsLayoutDesignerInterface(QtCore.QObject):
    ...
    class ExportResults(sip.wrapper):
        ...
        labelingResults: typing.Any = ...
        result: _core.QgsLayoutExporter.ExportResult = ...
...
class QgsLayoutItemPropertiesDialog(QtWidgets.QDialog):
    ...
    def setLayout(self, layout: _core.QgsLayout) -> None: ...  # type: ignore[override]
...
class QgsProcessingAlgorithmDialogBase(QtWidgets.QDialog, QgsProcessingParametersGenerator, QgsProcessingContextGenerator):
    ...
    def finished(self, successful: bool, result: typing.Dict[str, typing.Any], context: _core.QgsProcessingContext, feedback: _core.QgsProcessingFeedback) -> None: ...  # type: ignore[override]
...
class QgsProcessingToolboxModelNode(QtCore.QObject):
    ...
    def children(self) -> typing.List['QgsProcessingToolboxModelNode']: ...  # type: ignore[override]
...
class QgsModelComponentGraphicItem(QtWidgets.QGraphicsObject):
    ...
    def flags(self) -> 'QgsModelComponentGraphicItem.Flags': ...  # type: ignore[override]
...
class QgsHillshadeRendererWidget(QgsRasterRendererWidget):
    ...
    def renderer(self) -> _core.QgsRasterRenderer: ...
    @staticmethod
    def create(layer: _core.QgsRasterLayer, extent: _core.QgsRectangle) -> QgsRasterRendererWidget: ...  # type: ignore[override]
...
class QgsRasterTransparencyWidget(QgsMapLayerConfigWidget):
    ...
    def apply(self) -> None: ...
    def syncToLayer(self) -> None: ...  # type: ignore[override]
...
class QgsRendererRasterPropertiesWidget(QgsMapLayerConfigWidget):
    ...
    def syncToLayer(self, layer: _core.QgsRasterLayer) -> None: ...  # type: ignore[override]
    def apply(self) -> None: ...
...
class Qgs25DRendererWidget(QgsRendererWidget):
    ...
    def renderer(self) -> _core.QgsFeatureRenderer: ...
    @staticmethod
    def create(layer: _core.QgsVectorLayer, style: _core.QgsStyle, renderer: _core.QgsFeatureRenderer) -> QgsRendererWidget: ...  # type: ignore[override]
...
class QgsArrowSymbolLayerWidget(QgsSymbolLayerWidget):
    ...
    def setSymbolLayer(self, layer: _core.QgsSymbolLayer) -> None: ...
    @staticmethod
    def create(layer: _core.QgsVectorLayer) -> QgsSymbolLayerWidget: ...  # type: ignore[override]
...
class QgsEllipseSymbolLayerWidget(QgsSymbolLayerWidget):
    ...
    def setSymbolLayer(self, layer: _core.QgsSymbolLayer) -> None: ...
    @staticmethod
    def create(vl: _core.QgsVectorLayer) -> QgsSymbolLayerWidget: ...  # type: ignore[override]
