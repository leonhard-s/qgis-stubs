...
class QgsInterpolator(sip.wrapper):
    ...
    class LayerData(sip.wrapper):
        ...
        source: _core.QgsFeatureSource = ...
        sourceType: 'QgsInterpolator.SourceType' = ...
        transformContext: _core.QgsCoordinateTransformContext = ...
...
class QgsTinInterpolator(QgsInterpolator):
    ...
    def interpolatePoint(self, x: float, y: float, feedback: _core.QgsFeedback) -> typing.Tuple[int, float]: ...  # type: ignore[override]
...
class QgsGeometryCheckContext(sip.wrapper):
    ...
    mapCrs: _core.QgsCoordinateReferenceSystem = ...
...
class QgsSingleGeometryCheck(QgsGeometryCheck):
    ...
    def collectErrors(self, featurePools: typing.Any, errors: typing.Iterable[QgsGeometryCheckError], messages: typing.Iterable[str], feedback: typing.Optional[_core.QgsFeedback] = ..., ids: QgsGeometryCheck.LayerFeatureIds = ...) -> None: ...  # type: ignore[override]
