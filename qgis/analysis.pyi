...
class QgsGcpGeometryTransformer(_core.QgsAbstractGeometryTransformer):
    ...
    def __init__(self, method: 'QgsGcpTransformerInterface.TransformMethod', sourceCoordinates:
                 typing.Iterable[_core.QgsPointXY], destinationCoordinates: typing.Iterable[_core.QgsPointXY]) -> None: ...
    ...
    def transform(self, geometry: _core.QgsGeometry,
                  feedback: typing.Optional[_core.QgsFeedback] = ...) -> typing.Tuple[_core.QgsGeometry, bool]: ...
    def transformPoint(self, x: float, y: float, z: float,
                       m: float) -> typing.Tuple[bool, float, float, float, float]: ...
...
class QgsGcpTransformerInterface(sip.wrapper):
    ...
    @staticmethod
    def methodToString(
        method: 'QgsGcpTransformerInterface.TransformMethod') -> str: ...
    def transform(self, x: float, y: float,
                  inverseTransform: bool = ...) -> typing.Tuple[bool, float, float]: ...

    def method(self) -> 'QgsGcpTransformerInterface.TransformMethod': ...
    def minimumGcpCount(self) -> int: ...
    def updateParametersFromGcps(self, sourceCoordinates: typing.Iterable[_core.QgsPointXY],
                                 destinationCoordinates: typing.Iterable[_core.QgsPointXY], invertYAxis: bool = ...) -> bool: ...
...
class QgsGridFileWriter(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, interpolator: 'QgsInterpolator', outputPath: str,
                 extent: _core.QgsRectangle, nCols: int, nRows: int) -> None: ...

    @typing.overload
    def __init__(self, a0: 'QgsGridFileWriter') -> None: ...

    def writeFile(
        self, feedback: typing.Optional[_core.QgsFeedback] = ...) -> int: ...
...
class QgsInterpolator(sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, layerData: typing.Iterable['QgsInterpolator.LayerData']) -> None: ...
    ...
    def cacheBaseData(self, feedback: typing.Optional[_core.QgsFeedback] = ...) -> 'QgsInterpolator.Result':
        ...
    def interpolatePoint(self, x: float, y: float,
                         feedback: typing.Optional[_core.QgsFeedback] = ...) -> typing.Tuple[int, float]: ...
...
class QgsTinInterpolator(QgsInterpolator):
    ...
    @typing.overload
    def __init__(self, inputData: typing.Iterable[QgsInterpolator.LayerData],
                 interpolation: 'QgsTinInterpolator.TinInterpolation' = ..., feedback: typing.Optional[_core.QgsFeedback] = ...) -> None: ...
    ...
    def interpolatePoint(self, x: float, y: float,
                         feedback: _core.QgsFeedback) -> typing.Tuple[int, float]: ...
...
class QgsMeshContours(sip.wrapper):
    ...
    def exportPolygons(self, index: _core.QgsMeshDatasetIndex, min_value: float, max_value: float,
                       method: _core.QgsMeshRendererScalarSettings.DataResamplingMethod, feedback: typing.Optional[_core.QgsFeedback] = ...) -> _core.QgsGeometry: ...
    def exportLines(self, index: _core.QgsMeshDatasetIndex, value: float, method: _core.QgsMeshRendererScalarSettings.DataResamplingMethod,
                    feedback: typing.Optional[_core.QgsFeedback] = ...) -> _core.QgsGeometry: ...
...
class QgsMeshTriangulation(QtCore.QObject):
    ...
    def triangulatedMesh(
        self, feedback: typing.Optional[_core.QgsFeedback] = ...) -> _core.QgsMesh: ...

    def addBreakLines(self, lineFeatureIterator: _core.QgsFeatureIterator, valueAttribute: int, transformContext: _core.QgsCoordinateTransform,
                      feedback: typing.Optional[_core.QgsFeedback] = ..., featureCount: int = ...) -> bool: ...
    def addVertices(self, vertexFeatureIterator: _core.QgsFeatureIterator, valueAttribute: int, transform: _core.QgsCoordinateTransform,
                    feedback: typing.Optional[_core.QgsFeedback] = ..., featureCount: int = ...) -> bool: ...
...
class QgsMeshZValueDatasetGroup(_core.QgsMeshDatasetGroup):
    ...
    def writeXml(self, doc: QtXml.QDomDocument,
                 context: _core.QgsReadWriteContext) -> QtXml.QDomElement: ...

    def type(self) -> _core.QgsMeshDatasetGroup.Type: ...
    def dataset(self, index: int) -> _core.QgsMeshDataset: ...
    def datasetCount(self) -> int: ...
    def datasetMetadata(
        self, datasetIndex: int) -> _core.QgsMeshDatasetMetadata: ...
...
class QgsGraph(sip.wrapper):
    ...
    def addEdge(self, fromVertexIdx: int, toVertexIdx: int,
                strategies: typing.Iterable[typing.Any]) -> int: ...
...
class QgsGraphAnalyzer(sip.wrapper):
    ...
    @staticmethod
    def shortestTree(source: QgsGraph, startVertexIdx: int,
                     criterionNum: int) -> QgsGraph: ...

    @staticmethod
    def dijkstra(source: QgsGraph, startVertexIdx: int, criterionNum: int,
                 resultTree: typing.Optional[typing.Iterable[int]] = ..., resultCost: typing.Optional[typing.Iterable[float]] = ...) -> typing.List: ...


class QgsGraphBuilderInterface(sip.wrapper):

    @typing.overload
    def __init__(self, crs: _core.QgsCoordinateReferenceSystem, ctfEnabled: bool = ...,
                 topologyTolerance: float = ..., ellipsoidID: str = ...) -> None: ...

    @typing.overload
    def __init__(self, a0: 'QgsGraphBuilderInterface') -> None: ...

    def addEdge(self, pt1id: int, pt1: _core.QgsPointXY, pt2id: int,
                pt2: _core.QgsPointXY, strategies: typing.Iterable[typing.Any]) -> None: ...
...
class QgsGraphBuilder(QgsGraphBuilderInterface):
    ...
    def __init__(self, crs: _core.QgsCoordinateReferenceSystem, otfEnabled: bool = ...,
                 topologyTolerance: float = ..., ellipsoidID: str = ...) -> None: ...

    def graph(self) -> QgsGraph: ...
    def addEdge(self, pt1id: int, pt1: _core.QgsPointXY, pt2id: int,
                pt2: _core.QgsPointXY, prop: typing.Iterable[typing.Any]) -> None: ...
...
class QgsGraphDirector(QtCore.QObject):
    ...
    def makeGraph(self, builder: QgsGraphBuilderInterface,
                  additionalPoints: typing.Iterable[_core.QgsPointXY], feedback: typing.Optional[_core.QgsFeedback] = ...) -> typing.List[_core.QgsPointXY]: ...
...
class QgsNetworkSpeedStrategy(QgsNetworkStrategy):
    ...
    @typing.overload
    def __init__(self, attributeId: int, defaultValue: float,
                 toMetricFactor: float) -> None: ...
...
class QgsVectorLayerDirector(QgsGraphDirector):
    ...
    def __init__(self, source: _core.QgsFeatureSource, directionFieldId: int, directDirectionValue: str,
                 reverseDirectionValue: str, bothDirectionValue: str, defaultDirection: 'QgsVectorLayerDirector.Direction') -> None: ...
...
class QgsBatchGeocodeAlgorithm(_core.QgsProcessingFeatureBasedAlgorithm):
    ...
    def outputWkbType(
        self, inputWkbType: _core.QgsWkbTypes.Type) -> _core.QgsWkbTypes.Type: ...

    def outputFields(
        self, inputFields: _core.QgsFields) -> _core.QgsFields: ...

    def outputCrs(
        self, inputCrs: _core.QgsCoordinateReferenceSystem) -> _core.QgsCoordinateReferenceSystem: ...

    def processFeature(self, feature: _core.QgsFeature, a1: _core.QgsProcessingContext,
                       feedback: _core.QgsProcessingFeedback) -> typing.List[_core.QgsFeature]: ...
    def prepareAlgorithm(self, parameters: typing.Dict[str, typing.Any],
                         context: _core.QgsProcessingContext, feedback: _core.QgsProcessingFeedback) -> bool: ...
    ...
    def initParameters(
        self, configuration: typing.Dict[str, typing.Any] = ...) -> None: ...


class QgsNativeAlgorithms(_core.QgsProcessingProvider):

    def __init__(
        self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QgsAlignRaster(sip.wrapper):
    ...
    @staticmethod
    def suggestedWarpOutput(info: 'QgsAlignRaster.RasterInfo', destWkt: str, cellSize: typing.Optional[QtCore.QSizeF] = ..., gridOffset: typing.Optional[
                            typing.Union[QtCore.QPointF, QtCore.QPoint]] = ..., rect: typing.Optional[_core.QgsRectangle] = ...) -> bool: ...
    ...
    @typing.overload
    def setParametersFromRaster(self, rasterInfo: 'QgsAlignRaster.RasterInfo', customCRSWkt: str = ...,
                                customCellSize: QtCore.QSizeF = ..., customGridOffset: typing.Union[QtCore.QPointF, QtCore.QPoint] = ...) -> bool: ...

    @typing.overload
    def setParametersFromRaster(self, filename: str, customCRSWkt: str = ..., customCellSize: QtCore.QSizeF = ...,
                                customGridOffset: typing.Union[QtCore.QPointF, QtCore.QPoint] = ...) -> bool: ...

    def clipExtent(self) -> _core.QgsRectangle: ...

    @typing.overload
    def setClipExtent(self, xmin: float, ymin: float,
    ...
    def gridOffset(self) -> QtCore.QPointF: ...
    def setGridOffset(
        self, offset: typing.Union[QtCore.QPointF, QtCore.QPoint]) -> None: ...

    def rasters(self) -> typing.List['QgsAlignRaster.Item']: ...
    def setRasters(
        self, list: typing.Iterable['QgsAlignRaster.Item']) -> None: ...

    def progressHandler(self) -> 'QgsAlignRaster.ProgressHandler': ...
    def setProgressHandler(
        self, progressHandler: 'QgsAlignRaster.ProgressHandler') -> None: ...
...
class QgsNineCellFilter(sip.wrapper):
    ...
    def processNineCellWindow(self) -> typing.Tuple[float, float,
...
class QgsDerivativeFilter(QgsNineCellFilter):
    ...
    def calcFirstDerY(self) -> typing.Tuple[float, float, float,
                                            float, float, float, float, float, float, float]: ...

    def calcFirstDerX(self) -> typing.Tuple[float, float, float,
                                            float, float, float, float, float, float, float]: ...
    def processNineCellWindow(self) -> typing.Tuple[float, float,
                                                    float, float, float, float, float, float, float, float]: ...
...
class QgsExifTools(sip.wrapper):
    ...
    @staticmethod
    def geoTagImage(imagePath: str, location: _core.QgsPointXY,
                    details: 'QgsExifTools.GeoTagDetails' = ...) -> bool: ...
...
class QgsKernelDensityEstimation(sip.wrapper):
    ...
    class Parameters(sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, a0: 'QgsKernelDensityEstimation.Parameters') -> None: ...

    def __init__(self, parameters: 'QgsKernelDensityEstimation.Parameters',
                 outputFile: str, outputFormat: str) -> None: ...
...
class QgsRasterCalcNode(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, op: 'QgsRasterCalcNode.Operator',
                 left: 'QgsRasterCalcNode', right: 'QgsRasterCalcNode') -> None: ...
    ...
    def parseRasterCalcString(str: str, parserErrorMsg: str) -> 'QgsRasterCalcNode':
        ...
    def findNodes(
        self, type: 'QgsRasterCalcNode.Type') -> typing.List['QgsRasterCalcNode']: ...
...
class QgsRasterCalculator(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, formulaString: str, outputFile: str, outputFormat: str, outputExtent: _core.QgsRectangle, nOutputColumns: int, nOutputRows: int,
                 rasterEntries: typing.Iterable[QgsRasterCalculatorEntry], transformContext: _core.QgsCoordinateTransformContext) -> None: ...

    @typing.overload
    def __init__(self, formulaString: str, outputFile: str, outputFormat: str, outputExtent: _core.QgsRectangle, outputCrs: _core.QgsCoordinateReferenceSystem,
                 nOutputColumns: int, nOutputRows: int, rasterEntries: typing.Iterable[QgsRasterCalculatorEntry], transformContext: _core.QgsCoordinateTransformContext) -> None: ...

    @typing.overload
    def __init__(self, formulaString: str, outputFile: str, outputFormat: str, outputExtent: _core.QgsRectangle,
                 nOutputColumns: int, nOutputRows: int, rasterEntries: typing.Iterable[QgsRasterCalculatorEntry]) -> None: ...
...
class QgsRelief(sip.wrapper):
    ...
    class ReliefColor(sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], min: float, max: float) -> None: ...
    ...
    def calculateOptimizedReliefClasses(
        self) -> typing.List['QgsRelief.ReliefColor']: ...
    def setReliefColors(
        self, c: typing.Iterable['QgsRelief.ReliefColor']) -> None: ...
...
class QgsFeaturePool(_core.QgsFeatureSink):
    ...
    def insertFeature(self, feature: _core.QgsFeature,
                      skipLock: bool = ...) -> None: ...
...
class QgsGeometryCheck(sip.wrapper):
    ...
    class Flags(sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union['QgsGeometryCheck.Flags', 'QgsGeometryCheck.Flag']) -> None: ...
    ...
    class Change(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, _what: 'QgsGeometryCheck.ChangeWhat',
                     _type: 'QgsGeometryCheck.ChangeType', _vidx: _core.QgsVertexId = ...) -> None: ...
    ...
    @typing.overload
    def __init__(self, context: 'QgsGeometryCheckContext',
    ...
    def availableResolutionMethods(
        self) -> typing.List['QgsGeometryCheckResolutionMethod']: ...
    def collectErrors(self, featurePools: typing.Any, errors: typing.Iterable['QgsGeometryCheckError'], messages: typing.Iterable[str],
                      feedback: _core.QgsFeedback, ids: 'QgsGeometryCheck.LayerFeatureIds' = ...) -> typing.Tuple[typing.List['QgsGeometryCheckError'], typing.List[str]]: ...
    ...
    def prepare(self, context: 'QgsGeometryCheckContext',
                configuration: typing.Dict[str, typing.Any]) -> None: ...
...
class QgsGeometryCheckContext(sip.wrapper):
    ...
    def __init__(self, precision: int, mapCrs: _core.QgsCoordinateReferenceSystem,
                 transformContext: _core.QgsCoordinateTransformContext, mProject: _core.QgsProject) -> None: ...
...
class QgsGeometryCheckError(sip.wrapper):
    ...
    @typing.overload
    def __init__(self, check: QgsGeometryCheck, layerFeature: 'QgsGeometryCheckerUtils.LayerFeature', errorLocation: _core.QgsPointXY,
                 vidx: _core.QgsVertexId = ..., value: typing.Any = ..., valueType: 'QgsGeometryCheckError.ValueType' = ...) -> None: ...

    @typing.overload
    def __init__(self, check: QgsGeometryCheck, layerId: str, featureId: int, geometry: _core.QgsGeometry, errorLocation: _core.QgsPointXY,
                 vidx: _core.QgsVertexId = ..., value: typing.Any = ..., valueType: 'QgsGeometryCheckError.ValueType' = ...) -> None: ...
...
class QgsGeometryCheckerUtils(sip.wrapper):
    ...
    class LayerFeature(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, pool: QgsFeaturePool, feature: _core.QgsFeature,
                     context: QgsGeometryCheckContext, useMapCrs: bool) -> None: ...

        @typing.overload
        def __init__(
            self, a0: 'QgsGeometryCheckerUtils.LayerFeature') -> None: ...
...
class QgsGeometryCheckFactory(sip.wrapper):
    ...
    def description(self) -> str: ...
    def id(self) -> str: ...
    def createGeometryCheck(self, context: QgsGeometryCheckContext,
                            configuration: typing.Dict[str, typing.Any]) -> QgsGeometryCheck: ...
...
class QgsGeometryCheckRegistry(sip.wrapper):
    ...
    def registerGeometryCheck(
        self, checkFactory: QgsGeometryCheckFactory) -> None: ...

    def geometryCheckFactories(self, layer: _core.QgsVectorLayer, type: QgsGeometryCheck.CheckType,
                               flags: typing.Union[QgsGeometryCheck.Flags, QgsGeometryCheck.Flag] = ...) -> typing.List[QgsGeometryCheckFactory]: ...
    def geometryCheck(self, checkId: str, context: QgsGeometryCheckContext,
                      geometryCheckConfig: typing.Dict[str, typing.Any]) -> QgsGeometryCheck: ...


class QgsSingleGeometryCheckError(sip.wrapper):

    @typing.overload
    def __init__(self, check: 'QgsSingleGeometryCheck', geometry: _core.QgsGeometry,
                 errorLocation: _core.QgsGeometry, vertexId: _core.QgsVertexId = ...) -> None: ...
...
class QgsGeometryCheckErrorSingle(QgsGeometryCheckError):
    ...
    @typing.overload
    def __init__(self, singleError: QgsSingleGeometryCheckError,
                 layerFeature: QgsGeometryCheckerUtils.LayerFeature) -> None: ...
...
class QgsSingleGeometryCheck(QgsGeometryCheck):
    ...
    def processGeometry(
        self, geometry: _core.QgsGeometry) -> typing.List[QgsSingleGeometryCheckError]: ...
    def collectErrors(self, featurePools: typing.Any, errors: typing.Iterable[QgsGeometryCheckError], messages: typing.Iterable[
                      str], feedback: typing.Optional[_core.QgsFeedback] = ..., ids: QgsGeometryCheck.LayerFeatureIds = ...) -> None: ...
...
class QgsGeometrySnapper(QtCore.QObject):
    ...
    def snapFeatures(self, features: typing.Iterable[_core.QgsFeature], snapTolerance: float,
                     mode: 'QgsGeometrySnapper.SnapMode' = ...) -> typing.List[_core.QgsFeature]: ...

    @typing.overload
    def snapGeometry(self, geometry: _core.QgsGeometry, snapTolerance: float,
                     mode: 'QgsGeometrySnapper.SnapMode' = ...) -> _core.QgsGeometry: ...

    @typing.overload
    @staticmethod
    def snapGeometry(geometry: _core.QgsGeometry, snapTolerance: float, referenceGeometries:
                     typing.Iterable[_core.QgsGeometry], mode: 'QgsGeometrySnapper.SnapMode' = ...) -> _core.QgsGeometry: ...


class QgsInternalGeometrySnapper(sip.wrapper):

    @typing.overload
    def __init__(self, snapTolerance: float,
                 mode: QgsGeometrySnapper.SnapMode = ...) -> None: ...
...
class QgsGeometrySnapperSingleSource(sip.wrapper):
    ...
    @staticmethod
    def run(source: _core.QgsFeatureSource, sink: _core.QgsFeatureSink,
            thresh: float, feedback: _core.QgsFeedback) -> int: ...
...
class QgsZonalStatistics(sip.wrapper):
    ...
    class Statistics(sip.wrapper):
        ...
        @typing.overload
        def __init__(self, f: typing.Union['QgsZonalStatistics.Statistics',
                                           'QgsZonalStatistics.Statistic']) -> None: ...
    ...
    @typing.overload
    def __init__(self, polygonLayer: _core.QgsVectorLayer, rasterLayer: _core.QgsRasterLayer, attributePrefix: str = ...,
                 rasterBand: int = ..., stats: typing.Union['QgsZonalStatistics.Statistics', 'QgsZonalStatistics.Statistic'] = ...) -> None: ...

    @typing.overload
    def __init__(self, polygonLayer: _core.QgsVectorLayer, rasterInterface: _core.QgsRasterInterface, rasterCrs: _core.QgsCoordinateReferenceSystem, rasterUnitsPerPixelX: float,
                 rasterUnitsPerPixelY: float, attributePrefix: str = ..., rasterBand: int = ..., stats: typing.Union['QgsZonalStatistics.Statistics', 'QgsZonalStatistics.Statistic'] = ...) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def calculateStatistics(rasterInterface: _core.QgsRasterInterface, geometry: _core.QgsGeometry, cellSizeX: float, cellSizeY: float, rasterBand: int,
                            statistics: typing.Union['QgsZonalStatistics.Statistics', 'QgsZonalStatistics.Statistic']) -> typing.Dict[int, typing.Any]: ...
